...
##  /   /         Filename : example_ibert_zcb.xdc
## /___/   /\     
## \   \  /  \ 
##  \___\/\___\
##
...
##
set_property CLKFBOUT_MULT_F 8.000 [get_cells u_ibert_core/inst/SYSCLK_DIVIDER.U_GT_MMCM]
set_property DIVCLK_DIVIDE 1 [get_cells u_ibert_core/inst/SYSCLK_DIVIDER.U_GT_MMCM]
set_property CLKIN1_PERIOD 8.0 [get_cells u_ibert_core/inst/SYSCLK_DIVIDER.U_GT_MMCM]
set_property CLKOUT0_DIVIDE_F 10.000 [get_cells u_ibert_core/inst/SYSCLK_DIVIDER.U_GT_MMCM]
##
## Refclk constraints
##
create_clock -name gtrefclk0_0 -period 8.0 [get_ports GTREFCLK0P_I[0]]
create_clock -name gtrefclk1_0 -period 8.0 [get_ports GTREFCLK1P_I[0]]
...
set_property RXLPM_BIAS_STARTUP_DISABLE 1'b1 [get_cells u_ibert_core/inst/QUAD[0].u_q*/CH[*].u_ch/u_gtpe2_channel]
