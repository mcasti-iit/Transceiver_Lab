...
--               d:/Projects/Transceiver/ZCB/GTP_Zynq_ex/GTP_Zynq_ex.srcs/sources_1/ip/tx_GTP_Zynq/tx_GTP_Zynq_sim_netlist.vhdl
-- Design      : tx_GTP_Zynq
...
entity tx_GTP_Zynq_tx_GTP_Zynq_GT is
  port (
  ...
  attribute ORIG_REF_NAME of tx_GTP_Zynq_tx_GTP_Zynq_GT : entity is "tx_GTP_Zynq_GT";
end tx_GTP_Zynq_tx_GTP_Zynq_GT;

architecture STRUCTURE of tx_GTP_Zynq_tx_GTP_Zynq_GT is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity tx_GTP_Zynq_tx_GTP_Zynq_sync_block is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of tx_GTP_Zynq_tx_GTP_Zynq_sync_block : entity is "tx_GTP_Zynq_sync_block";
end tx_GTP_Zynq_tx_GTP_Zynq_sync_block;

architecture STRUCTURE of tx_GTP_Zynq_tx_GTP_Zynq_sync_block is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity tx_GTP_Zynq_tx_GTP_Zynq_sync_block_0 is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of tx_GTP_Zynq_tx_GTP_Zynq_sync_block_0 : entity is "tx_GTP_Zynq_sync_block";
end tx_GTP_Zynq_tx_GTP_Zynq_sync_block_0;

architecture STRUCTURE of tx_GTP_Zynq_tx_GTP_Zynq_sync_block_0 is
  signal data_sync1 : STD_LOGIC;
  signal data_sync2 : STD_LOGIC;
  signal data_sync3 : STD_LOGIC;
  signal data_sync4 : STD_LOGIC;
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity tx_GTP_Zynq_tx_GTP_Zynq_sync_block_1 is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of tx_GTP_Zynq_tx_GTP_Zynq_sync_block_1 : entity is "tx_GTP_Zynq_sync_block";
end tx_GTP_Zynq_tx_GTP_Zynq_sync_block_1;

architecture STRUCTURE of tx_GTP_Zynq_tx_GTP_Zynq_sync_block_1 is
  signal data_sync1 : STD_LOGIC;
  signal data_sync2 : STD_LOGIC;
  signal data_sync3 : STD_LOGIC;
  signal data_sync4 : STD_LOGIC;
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity tx_GTP_Zynq_tx_GTP_Zynq_sync_block_2 is
  port (
    data_out : out STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of tx_GTP_Zynq_tx_GTP_Zynq_sync_block_2 : entity is "tx_GTP_Zynq_sync_block";
end tx_GTP_Zynq_tx_GTP_Zynq_sync_block_2;

architecture STRUCTURE of tx_GTP_Zynq_tx_GTP_Zynq_sync_block_2 is
  signal data_sync1 : STD_LOGIC;
  signal data_sync2 : STD_LOGIC;
  signal data_sync3 : STD_LOGIC;
  signal data_sync4 : STD_LOGIC;
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity tx_GTP_Zynq_tx_GTP_Zynq_sync_block_3 is
  port (
    data_out : out STD_LOGIC;
    data_in : in STD_LOGIC;
    SYSCLK_IN : in STD_LOGIC
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of tx_GTP_Zynq_tx_GTP_Zynq_sync_block_3 : entity is "tx_GTP_Zynq_sync_block";
end tx_GTP_Zynq_tx_GTP_Zynq_sync_block_3;

architecture STRUCTURE of tx_GTP_Zynq_tx_GTP_Zynq_sync_block_3 is
  signal data_sync1 : STD_LOGIC;
  signal data_sync2 : STD_LOGIC;
  signal data_sync3 : STD_LOGIC;
  signal data_sync4 : STD_LOGIC;
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity tx_GTP_Zynq_tx_GTP_Zynq_sync_block_4 is
  port (
    data_out : out STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of tx_GTP_Zynq_tx_GTP_Zynq_sync_block_4 : entity is "tx_GTP_Zynq_sync_block";
end tx_GTP_Zynq_tx_GTP_Zynq_sync_block_4;

architecture STRUCTURE of tx_GTP_Zynq_tx_GTP_Zynq_sync_block_4 is
  signal data_sync1 : STD_LOGIC;
  signal data_sync2 : STD_LOGIC;
  signal data_sync3 : STD_LOGIC;
  signal data_sync4 : STD_LOGIC;
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity tx_GTP_Zynq_tx_GTP_Zynq_TX_STARTUP_FSM is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of tx_GTP_Zynq_tx_GTP_Zynq_TX_STARTUP_FSM : entity is "tx_GTP_Zynq_TX_STARTUP_FSM";
end tx_GTP_Zynq_tx_GTP_Zynq_TX_STARTUP_FSM;

architecture STRUCTURE of tx_GTP_Zynq_tx_GTP_Zynq_TX_STARTUP_FSM is
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \FSM_sequential_tx_state[3]_i_5\ : label is "soft_lutpair3";
  ...
  attribute SOFT_HLUTNM of TXUSERRDY_i_1 : label is "soft_lutpair1";
  ...
  attribute SOFT_HLUTNM of \init_wait_count[2]_i_1\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \init_wait_count[3]_i_1\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \init_wait_count[4]_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \init_wait_count[6]_i_3\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \init_wait_count[6]_i_4\ : label is "soft_lutpair6";
  ...
  attribute SOFT_HLUTNM of run_phase_alignment_int_i_1 : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \time_out_counter[0]_i_6\ : label is "soft_lutpair9";
...
sync_PLL0LOCK: entity work.tx_GTP_Zynq_tx_GTP_Zynq_sync_block
     port map (
...
sync_TXRESETDONE: entity work.tx_GTP_Zynq_tx_GTP_Zynq_sync_block_0
     port map (
      SYSCLK_IN => SYSCLK_IN,
      data_out => txresetdone_s2,
      gt0_txresetdone_out => gt0_txresetdone_out
    );
sync_mmcm_lock_reclocked: entity work.tx_GTP_Zynq_tx_GTP_Zynq_sync_block_1
     port map (
...
sync_run_phase_alignment_int: entity work.tx_GTP_Zynq_tx_GTP_Zynq_sync_block_2
     port map (
      data_in => run_phase_alignment_int_reg_n_0,
      data_out => data_out,
      gt0_txusrclk_in => gt0_txusrclk_in
    );
sync_time_out_wait_bypass: entity work.tx_GTP_Zynq_tx_GTP_Zynq_sync_block_3
     port map (
      SYSCLK_IN => SYSCLK_IN,
      data_in => time_out_wait_bypass_reg_n_0,
      data_out => time_out_wait_bypass_s2
    );
sync_tx_fsm_reset_done_int: entity work.tx_GTP_Zynq_tx_GTP_Zynq_sync_block_4
     port map (
      GT0_TX_FSM_RESET_DONE_OUT => \^gt0_tx_fsm_reset_done_out\,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity tx_GTP_Zynq_tx_GTP_Zynq_multi_gt is
  port (
    gt0_drprdy_out : out STD_LOGIC;
    gt0_eyescandataerror_out : out STD_LOGIC;
    gt0_gtptxn_out : out STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of tx_GTP_Zynq_tx_GTP_Zynq_multi_gt : entity is "tx_GTP_Zynq_multi_gt";
end tx_GTP_Zynq_tx_GTP_Zynq_multi_gt;

architecture STRUCTURE of tx_GTP_Zynq_tx_GTP_Zynq_multi_gt is
begin
gt0_tx_GTP_Zynq_i: entity work.tx_GTP_Zynq_tx_GTP_Zynq_GT
     port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity tx_GTP_Zynq_tx_GTP_Zynq_init is
  port (
    SYSCLK_IN : in STD_LOGIC;
    SOFT_RESET_TX_IN : in STD_LOGIC;
  ...
  attribute EXAMPLE_SIMULATION of tx_GTP_Zynq_tx_GTP_Zynq_init : entity is 0;
  attribute EXAMPLE_SIM_GTRESET_SPEEDUP : string;
  attribute EXAMPLE_SIM_GTRESET_SPEEDUP of tx_GTP_Zynq_tx_GTP_Zynq_init : entity is "TRUE";
  attribute EXAMPLE_USE_CHIPSCOPE : integer;
  attribute EXAMPLE_USE_CHIPSCOPE of tx_GTP_Zynq_tx_GTP_Zynq_init : entity is 0;
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of tx_GTP_Zynq_tx_GTP_Zynq_init : entity is "tx_GTP_Zynq_init";
  attribute STABLE_CLOCK_PERIOD : integer;
  attribute STABLE_CLOCK_PERIOD of tx_GTP_Zynq_tx_GTP_Zynq_init : entity is 8;
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of tx_GTP_Zynq_tx_GTP_Zynq_init : entity is "yes";
end tx_GTP_Zynq_tx_GTP_Zynq_init;

architecture STRUCTURE of tx_GTP_Zynq_tx_GTP_Zynq_init is
...
gt0_txresetfsm_i: entity work.tx_GTP_Zynq_tx_GTP_Zynq_TX_STARTUP_FSM
     port map (
      GT0_PLL0LOCK_IN => GT0_PLL0LOCK_IN,
...
tx_GTP_Zynq_i: entity work.tx_GTP_Zynq_tx_GTP_Zynq_multi_gt
     port map (
      GT0_PLL0OUTCLK_IN => GT0_PLL0OUTCLK_IN,
      GT0_PLL0OUTREFCLK_IN => GT0_PLL0OUTREFCLK_IN,
      GT0_PLL1OUTCLK_IN => GT0_PLL1OUTCLK_IN,
...
entity tx_GTP_Zynq is
  ...
  attribute NotValidForBitStream of tx_GTP_Zynq : entity is true;
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of tx_GTP_Zynq : entity is "yes";
  attribute x_core_info : string;
  attribute x_core_info of tx_GTP_Zynq : entity is "tx_GTP_Zynq,gtwizard_v3_6_11,{protocol_file=Start_from_scratch}";
end tx_GTP_Zynq;

architecture STRUCTURE of tx_GTP_Zynq is
  attribute EXAMPLE_SIMULATION : integer;
...
begin
U0: entity work.tx_GTP_Zynq_tx_GTP_Zynq_init
     port map (
