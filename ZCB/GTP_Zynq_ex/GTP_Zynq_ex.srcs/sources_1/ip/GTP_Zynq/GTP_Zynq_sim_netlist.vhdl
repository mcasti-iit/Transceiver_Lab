...
-- Date        : Thu Oct  1 15:03:41 2020
-- Host        : IITICUBWS052 running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim
--               d:/Projects/Transceiver/ZCB/GTP_Zynq_ex/GTP_Zynq_ex.srcs/sources_1/ip/GTP_Zynq/GTP_Zynq_sim_netlist.vhdl
-- Design      : GTP_Zynq
...
architecture STRUCTURE of GTP_Zynq_GTP_Zynq_common_reset is
  ...
  attribute SOFT_HLUTNM of COMMON_RESET_i_1 : label is "soft_lutpair41";
  attribute SOFT_HLUTNM of common_reset_asserted_i_1 : label is "soft_lutpair41";
  attribute SOFT_HLUTNM of \init_wait_count[1]_i_1\ : label is "soft_lutpair40";
  attribute SOFT_HLUTNM of \init_wait_count[2]_i_1\ : label is "soft_lutpair39";
  attribute SOFT_HLUTNM of \init_wait_count[3]_i_1\ : label is "soft_lutpair40";
  attribute SOFT_HLUTNM of \init_wait_count[4]_i_1\ : label is "soft_lutpair37";
  attribute SOFT_HLUTNM of \init_wait_count[6]_i_1\ : label is "soft_lutpair38";
  attribute SOFT_HLUTNM of \init_wait_count[7]_i_2\ : label is "soft_lutpair38";
  attribute SOFT_HLUTNM of \init_wait_count[7]_i_3\ : label is "soft_lutpair39";
...
architecture STRUCTURE of GTP_Zynq_GTP_Zynq_RX_STARTUP_FSM is
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \FSM_sequential_rx_state[2]_i_2\ : label is "soft_lutpair20";
  attribute SOFT_HLUTNM of \FSM_sequential_rx_state[3]_i_10\ : label is "soft_lutpair27";
  attribute SOFT_HLUTNM of \FSM_sequential_rx_state[3]_i_11\ : label is "soft_lutpair31";
  attribute SOFT_HLUTNM of \FSM_sequential_rx_state[3]_i_13\ : label is "soft_lutpair30";
  attribute SOFT_HLUTNM of \FSM_sequential_rx_state[3]_i_14\ : label is "soft_lutpair20";
  attribute SOFT_HLUTNM of \FSM_sequential_rx_state[3]_i_5\ : label is "soft_lutpair19";
  attribute SOFT_HLUTNM of \FSM_sequential_rx_state[3]_i_8\ : label is "soft_lutpair30";
  ...
  attribute SOFT_HLUTNM of \init_wait_count[1]_i_1__0\ : label is "soft_lutpair32";
  ...
  attribute SOFT_HLUTNM of \init_wait_count[6]_i_3\ : label is "soft_lutpair25";
  attribute SOFT_HLUTNM of \init_wait_count[6]_i_4\ : label is "soft_lutpair23";
  attribute SOFT_HLUTNM of \mmcm_lock_count[0]_i_1\ : label is "soft_lutpair35";
  ...
  attribute SOFT_HLUTNM of \mmcm_lock_count[3]_i_1\ : label is "soft_lutpair28";
  attribute SOFT_HLUTNM of \mmcm_lock_count[4]_i_1\ : label is "soft_lutpair18";
  attribute SOFT_HLUTNM of \mmcm_lock_count[6]_i_1\ : label is "soft_lutpair29";
  attribute SOFT_HLUTNM of \mmcm_lock_count[7]_i_3\ : label is "soft_lutpair29";
  attribute SOFT_HLUTNM of \mmcm_lock_count[7]_i_4\ : label is "soft_lutpair18";
  attribute SOFT_HLUTNM of reset_time_out_i_5 : label is "soft_lutpair21";
  attribute SOFT_HLUTNM of run_phase_alignment_int_i_1 : label is "soft_lutpair19";
  attribute SOFT_HLUTNM of time_out_100us_i_6 : label is "soft_lutpair24";
  attribute SOFT_HLUTNM of time_out_100us_i_8 : label is "soft_lutpair33";
  attribute SOFT_HLUTNM of time_out_1us_i_4 : label is "soft_lutpair24";
  attribute SOFT_HLUTNM of \time_out_counter[0]_i_5\ : label is "soft_lutpair26";
  attribute SOFT_HLUTNM of \time_out_counter[0]_i_6\ : label is "soft_lutpair33";
  attribute SOFT_HLUTNM of \time_out_counter[0]_i_7\ : label is "soft_lutpair26";
  attribute SOFT_HLUTNM of \wait_time_cnt[0]_i_1\ : label is "soft_lutpair36";
  attribute SOFT_HLUTNM of \wait_time_cnt[1]_i_1\ : label is "soft_lutpair36";
  attribute SOFT_HLUTNM of \wait_time_cnt[2]_i_1\ : label is "soft_lutpair34";
  attribute SOFT_HLUTNM of \wait_time_cnt[3]_i_1\ : label is "soft_lutpair31";
  attribute SOFT_HLUTNM of \wait_time_cnt[4]_i_1\ : label is "soft_lutpair22";
  attribute SOFT_HLUTNM of \wait_time_cnt[6]_i_3\ : label is "soft_lutpair27";
  attribute SOFT_HLUTNM of \wait_time_cnt[6]_i_4\ : label is "soft_lutpair34";
  attribute SOFT_HLUTNM of \wait_time_cnt[6]_i_5\ : label is "soft_lutpair22";
begin
  AR(0) <= \^ar\(0);
